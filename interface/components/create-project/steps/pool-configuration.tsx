...
export function PoolConfiguration({ formData, updateFormData, onNext, onBack }: StepProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Pool Configuration</h2>
        <p className="mt-2 text-gray-600">Select the pool mode and configure parameters</p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex space-x-4">
          ...
          >
            ...
            <div className="text-sm mt-1 opacity-75">MM-only operations, no public trading</div>
          </button>
          ...
          >
            ...
            <div className="text-sm mt-1 opacity-75">Public trading with graduation mechanism</div>
          </button>
        </div>
        ...
        {formData.mode === PoolMode.DIRECT_POOL ? (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-2">
              <p className="text-sm font-medium text-gray-700">Initial price will be calculated based on:</p>
