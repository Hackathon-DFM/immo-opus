  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-gray-600">Set the borrowing time limit for Market Makers</p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="w-20 text-center">
              <span className="text-2xl font-semibold">{secondsToDays(formData.borrowTimeLimit)}</span>
        ...
        <div className="bg-gray-50 p-4 rounded-lg space-y-2">
          <h3 className="font-medium text-gray-900">What is the borrow time limit?</h3>
