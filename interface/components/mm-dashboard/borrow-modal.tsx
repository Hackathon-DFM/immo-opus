        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <select
                disabled
                className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed appearance-none"
                value="gtx"
              >
            ...
            <p className="mt-1 text-xs text-gray-500">Trading platform for borrowed tokens</p>
          </div>
