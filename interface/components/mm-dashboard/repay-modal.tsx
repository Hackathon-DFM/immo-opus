      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg max-w-md w-full p-6 my-8 max-h-[90vh] overflow-y-auto animate-fade-in-scale">
        ...
        <div className="space-y-4">
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg space-y-3">
            ...
            <div className="flex justify-between text-sm">
              <span className="font-medium text-gray-600 dark:text-gray-400">Borrowed Amount:</span>
              <span className="font-medium dark:text-gray-200">{parseFloat(borrowedFormatted).toLocaleString()} {symbol}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="font-medium text-gray-600 dark:text-gray-400">Your Balance:</span>
              <span className="font-medium dark:text-gray-200">{parseFloat(balanceFormatted).toLocaleString()} {symbol}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="font-medium text-gray-600 dark:text-gray-400">Time Remaining:</span>
          ...
          <div className="flex space-x-3 pt-2">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-green-600 dark:bg-green-500 text-white font-medium rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
